...
interface TripDetailChiangMaiProps {
  trip: Trip;
  onBack: () => void;
...
// Dynamic helper to fetch members associated with this trip
...
export default function TripDetailChiangMai({ 
  trip, 
  onBack, 
  onAddExpenseClick, 
  onDeleteExpense,
  onUpdateTrip
}: TripDetailChiangMaiProps) {
  ...
  // Compute settlements from expenses
    ...
    <div className="space-y-8 animate-fade-in font-sans">
      ...
      {activeTab === 'overview' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Summary Cards replaced by Category breakdown chart */}
          <div className="lg:col-span-8 grid grid-cols-1 gap-6">
            {/* Category breakdown (Donut representation + Details) */}
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 space-y-6 flex flex-col justify-between">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-around gap-6 my-4">
                {/* Custom Pie/Donut with concentric borders */}
          ...
          {/* Featured Image / Map Placeholder */}
      ...
      {activeTab === 'settlement' && (
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 space-y-6">
          ...
          <div className="space-y-4">
            {settlements.map((settlement, index) => (
              ...
              >
                ...
                {/* Bank account section for unpaid */}
                {!settlement.isSettled && (
          ...
          {/* Individual Expenses Detailed Breakdown */}
          <div className="border-t border-slate-100 pt-6 space-y-4">
            ...
            <div className="space-y-3">
              {getTripMembers(trip).map((member, idx) => {
                ...
                // Filter expenses this member participated in
